...
from tensorflow.keras.layers import Flaten, Dense # класс для создания полносвязных слоев нейросети
...
def create_model():
    ...
    model.compile(loss='categorical_crossentropy', optimizer='adam', metric=['accuracy']) # лос-вычисляет насколько наше распределение вероятностей далеко от правды
